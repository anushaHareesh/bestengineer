            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) => AddNewProduct(
                        ...
                        enqId: value.enId.toString(),
                        page: "quotation edit",
                        type: "edit quot",
                        rwId: widget.row_id.toString(),
                      )),
            );
          },
          label: Text(
                ...
                builder: (context, value, child) {
                  return Column(
                    children: [
                      ...
                      value.quotationEditList.length == 0
                          ? Center(
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                double tnet = double.parse(value
                                    .quotationEditList[index]["net_total"]);
